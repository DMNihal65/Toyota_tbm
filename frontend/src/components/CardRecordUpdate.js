...
function ModalForm(props) {
  ...
  return (
    <Modal show={showModal} onHide={handleClose}>
      <Modal.Header closeButton className={cardType}>
        <Modal.Title>Update Card</Modal.Title>
      </Modal.Header>
      <Modal.Body className={cardType}>
        <div>
          ...
          <div className="h5 ">
            <Select
              options={optionsCard}
              defaultValue={{ label: `${cardType} Card`, value: `${cardType}` }}
          ...
          <form onSubmit={formHandler} className="form-group mx-3">
            ...
            <div className="d-flex flex-column">
              ...
              <Select
                className="d-inline"
                options={options}
                defaultValue={{ value: `${statusM}`, label: `${statusM}` }}
                menuPlacement="top"
      ...
      <Modal.Footer className={cardType}>
